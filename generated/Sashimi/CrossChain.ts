...
export class MaxAmountChanged extends ethereum.Event {
  get params(): MaxAmountChanged__Params {
    return new MaxAmountChanged__Params(this);
  }
}

export class MaxAmountChanged__Params {
  _event: MaxAmountChanged;

  constructor(event: MaxAmountChanged) {
    this._event = event;
  }
...
export class MinAmountChanged extends ethereum.Event {
  get params(): MinAmountChanged__Params {
    return new MinAmountChanged__Params(this);
  }
}

export class MinAmountChanged__Params {
  _event: MinAmountChanged;

  constructor(event: MinAmountChanged) {
    this._event = event;
  }
...
export class CrossChain extends ethereum.SmartContract {
  ...
  maxAmount(param0: Address): BigInt {
    let result = super.call("maxAmount", "maxAmount(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_maxAmount(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("maxAmount", "maxAmount(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  minAmount(param0: Address): BigInt {
    let result = super.call("minAmount", "minAmount(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_minAmount(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("minAmount", "minAmount(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  receiveToken(
    ...
    let result = super.call(
      "receiveToken",
      "receiveToken(address,uint256,address,string):(uint256)",
      [
        ethereum.Value.fromAddress(token),
        ethereum.Value.fromUnsignedBigInt(amount),
        ethereum.Value.fromAddress(receiveAddress),
        ethereum.Value.fromString(info)
      ]
    );
